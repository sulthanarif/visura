            ...
            .insert([
              {
                ...
                date: result.date,
                image_paths: {
                  original: `png/ocr/original/${path.basename(
                    result.images.original
                  )}`,
                  hidpi: `png/ocr/hidpi/${path.basename(result.images.hidpi)}`,
                  rotated: `png/ocr/rotate/${path.basename(
                    result.images.rotated
                  )}`,
                  cropped: `png/ocr/cuts/${path.basename(
                    result.images.cropped
                  )}`,
                  parts: result.images.parts.map(
                    (p) => `png/ocr/cuts/part/${path.basename(p)}`
                  ),
                },
              },
            ])
