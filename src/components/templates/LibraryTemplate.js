...
const LibraryTemplate = ({
    ...
    <section className="p-3 sm:p-5">
        ...
        <SectionHeader title="Library Transmittal" onSearchChange={handleSearchChange} className="ml-30" />
        ...
        <ModalConfirmation
           isOpen={deleteModalOpen}
            ...
            title={`Hapus project ${projectToDelete?.projectName}?`}
             message={`Anda akan menghapus project ${projectToDelete?.projectName}. Data yang dihapus tidak dapat dikembalikan. Pastikan Anda telah mempertimbangkan keputusan ini.`}
